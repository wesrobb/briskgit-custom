Requirements for building D-Type examples on Linux:
---------------------------------------------------

- A recent Linux distribution (e.g. Debian 10)
- A recent gcc (e.g. gcc 8.3) with g++ (the GNU C++ compiler)
- X11 (The X Window System) with libx11-dev (development headers for X11)


How to build D-Type examples from the command line using the gcc compiler?
--------------------------------------------------------------------------

First, open command prompt and change your current working directory to the
...
Step 3.
  ...
  sudo ./03-copy_all_examples_to_exec
...
./example_color_rasterizer_linux
