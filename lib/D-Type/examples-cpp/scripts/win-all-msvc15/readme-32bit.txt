...
----------------------------------------------------------------------------
  ...
  Open msvc15-32bit.bat in your text editor and, if necessary, modify the paths
...
Step 2.
  ...
  Run either the "02-make_all_examples-32bit-dll.bat" or the
  "02-make_all_examples-32bit-static.bat" batch file (either from the command
