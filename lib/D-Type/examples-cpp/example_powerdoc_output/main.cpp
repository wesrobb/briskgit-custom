...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "------------------------------------------------------\n";
	std::cout << "D-TYPE POWER ENGINE OUTPUT DEMO\n";
	std::cout << "Source File: examples/example_powerdoc_output/main.cpp\n";
	std::cout << "------------------------------------------------------\n";
	std::cout << "\n";
	std::cout << "This sample program shows how to create and render PowerDoc documents\n";
	std::cout << "using D-Type Power Engine.\n";
	std::cout << "\n";
