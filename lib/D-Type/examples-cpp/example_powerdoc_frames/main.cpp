...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "------------------------------------------------------\n";
	std::cout << "D-TYPE POWER ENGINE FRAMES DEMO\n";
	std::cout << "Source File: examples/example_powerdoc_frames/main.cpp\n";
	std::cout << "------------------------------------------------------\n";
	std::cout << "\n";
	std::cout << "This sample program shows how to retrieve and process Text Flows and Frames\n";
	std::cout << "that D-Type Power Engine generates during its text layout operations.\n";
	std::cout << "\n";
