...
class CDTTextDocDemo6 : public CDTTextDoc
{
public:

	CDTTextDocDemo6(CDTEngineV8* engine, const DT_CHAR* filename)
	{
...
void CDTTextDocDemo6::SetFlow()
{
	DT_TX_TEXTFLOW_AREA textflow_areas[4] =
	{
		{  10, 10, 290, 800, TX_RECT, TX_TYPOROW, 0, TX_DIR_ROW_LR_TB, TX_LAY_MIXED_B, TX_TM_NULL, {DV_NULL}},
		{ 350, 10, 290, 800, TX_RECT, TX_TYPOROW, 0, TX_DIR_COL_TB_RL, TX_LAY_MIXED_B, TX_TM_NULL, {DV_NULL}},
		{  10, 10, 290, 800, TX_RECT, TX_TYPOROW, 0, TX_DIR_ROW_LR_TB, TX_LAY_MIXED_B, TX_TM_NULL, {DV_NULL}},
		{ 350, 10, 290, 800, TX_RECT, TX_TYPOROW, 0, TX_DIR_COL_TB_RL, TX_LAY_MIXED_B, TX_TM_NULL, {DV_NULL}}
	};

	DT_SLONG pages[4] = {0, 0, 1, 1};

	TextDoc.SetFlow(4, textflow_areas, pages);
}


void CDTTextDocDemo6::SetExtras()
{
	...
	DT_TX_DOC_PARAMS tx_params = {(1 | 2 | 4 | 8), (1 | 16), &pd_params};
