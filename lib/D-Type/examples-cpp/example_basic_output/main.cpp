...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "---------------------------------------------------\n";
	std::cout << "D-TYPE STANDARD ENGINE OUTPUT DEMO\n";
	std::cout << "Source File: examples/example_basic_output/main.cpp\n";
	std::cout << "---------------------------------------------------\n";
	std::cout << "\n";
	std::cout << "This sample program shows how to render text and scalable 2D graphics using\n";
	std::cout << "D-Type Font Engine and D-Type Rasterizer.\n";
	std::cout << "\n";
