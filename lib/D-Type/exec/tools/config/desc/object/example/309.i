...
local obj_10 = o("Form Rich Button");
...
obj_8 + s(pdTextString_08, "Rich Button");
...
obj_10 + p(fcName, "IDRICHBUTTON", PD_ASC);
obj_10 + i(fcDw, 600);
obj_10 + i(fcDh, 100);
obj_10 + i(fcState, 0);
obj_10 + i(fcUserParam, 100);
obj_10 + i(fcOnCtrlPush, 1);
obj_10 + i(fcOnCtrlRelease, 2);

/* Image Pinning */

obj_10.Pin(0, 50, 50, fcDrawRichButton);
