...
obj_8 + s(pdTextString_08, "This is a simple text fragment");

obj_9 + l(pdTextFragmentPtr, obj_8);
obj_9 + i(pdTextAreaDw, 800);
obj_9 + i(pdTextAreaDh, 400);

/* Image Pinning */

obj_9.Pin(0, 50, 50, pdDrawRichTextArea);
